...
args = \
    {
        'development': {
            'model': r'C:\Users\Eugene\Desktop\etri_final-main\Datahub\model\phrase\ko_combine.bin',
            'raw_model': '../model/ko_new.bin',
            'query_model' : r'C:\Users\Eugene\Desktop\etri_final-main\Datahub\model\qeury_txt.bin',
...
queries= {
    "semantic_search_query": {
            "query": {
                "query_string": {
                    "query": "query_list", #query_list는 변경해서 사용
                    "fields": ["*"],
    ...
    "semantic_search_query_for_extended_metadata":  {
            "query": {
                "nested": {
